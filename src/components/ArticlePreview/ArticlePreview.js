    ...
    <div className="preview-card">
      <div className="preview-header">
        <div className="title-likes">
          <Link to={`/articles/${slug}`} className="preview-title">
            {title}
          </Link>
      ...
      <div className="preview-footer">
        ...
        <img
          className="avatar"
          src={
            author.image || "https://avatars.githubusercontent.com/u/9919?v=4"
          }
          alt="author"
        />
      </div>
